...
NOPE:
    BSF	    SALIDA	    ;ENCIENDE LA SALIDA
    MOVFF   T_BAJO,TMR0	    ;MUEVE EL VALOR DE TIEMPO BAJO A TMR0
    GOTO    SALIR
    
SIPE:
    BCF	    SALIDA	    ;APAGA LA SALIDA
    MOVFF   T_ALTO,TMR0	    ;MUEVE EL VALOR DE TIEMPO ALTO A TMRO
    GOTO    SALIR
